...
// Update row
$theq = "UPDATE ".TABLE_PREFIX."mod_".$tablename." SET title = '$title', short_description = '$short_description', link = '$topic_link', content_short = '$short', content_long = '$long', content_extra = '$extra', txtr1 = '$txtr1', txtr2 = '$txtr2', txtr3 = '$txtr3', commenting = '$commenting', active = '$active', hascontent = '$hascontent', published_when = '$publishedwhen', published_until = '$publisheduntil', picture = '$picture', description = '$description', keywords = '$keywords'" . $queryextra ." WHERE topic_id = '$topic_id'";
$database->query($theq);
...
if ($copytopic == 1) {
	...
	if ($publisheduntil < $t + 3600) $publisheduntil = $t + 3600;
	
	$theq = "INSERT INTO ".TABLE_PREFIX."mod_".$tablename." SET section_id = '$section_id', page_id = '$page_id', posted_first = '$posted_first', posted_by = '$posted_by', authors = '$posted_by', title = '$title', short_description = '$short_description', link = '$topic_link', content_short = '$short', content_long = '$long', content_extra = '$extra', txtr1 = '$txtr1', txtr2 = '$txtr2', txtr3 = '$txtr3', commenting = '$commenting', active = '$active', hascontent = '$hascontent', published_when = '$publishedwhen', published_until = '$publisheduntil', picture = '$picture', description = '$description', keywords = '$keywords'";
	//die($theq);
	$database->query($theq);
	// Get the id
