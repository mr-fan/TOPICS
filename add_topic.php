...
$database->query("INSERT INTO ".TABLE_PREFIX."mod_".$tablename." (section_id,page_id,position,commenting,active,posted_by,authors,posted_first) VALUES ('$section_id','$page_id','$position','$commenting','1','$theuser',',$theuser,','$t')");
